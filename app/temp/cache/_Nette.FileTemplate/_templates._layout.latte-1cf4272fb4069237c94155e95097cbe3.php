<?php //netteCache[01]000383a:2:{s:4:"time";s:21:"0.51460000 1398769001";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:61:"D:\WEB_SERVER\novy-strom-projektu\app\templates\@layout.latte";i:2;i:1398768911;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"dc83a21 released on 2013-07-11";}}}?><?php

// source file: D:\WEB_SERVER\novy-strom-projektu\app\templates\@layout.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'nl5xqx5wjr')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block canonical
//
if (!function_exists($_l->blocks['canonical'][] = '_lb83c81520a0_canonical')) { function _lb83c81520a0_canonical($_l, $_args) { extract($_args)
;
}}
...
// block logo
//
if (!function_exists($_l->blocks['logo'][] = '_lb8d8d4f8489_logo')) { function _lb8d8d4f8489_logo($_l, $_args) { extract($_args)
?>span<?php
}}
...
// block logo_end
//
if (!function_exists($_l->blocks['logo_end'][] = '_lbb45539573b_logo_end')) { function _lbb45539573b_logo_end($_l, $_args) { extract($_args)
?>span<?php
}}
...
// block _cartbox
//
if (!function_exists($_l->blocks['_cartbox'][] = '_lbe1f6b9c8d1__cartbox')) { function _lbe1f6b9c8d1__cartbox($_l, $_args) { extract($_args); $_control->validateControl('cartbox')
?>                    <div id="out-top-cart">
...
// block banner
//
if (!function_exists($_l->blocks['banner'][] = '_lb2db6471304_banner')) { function _lb2db6471304_banner($_l, $_args) { extract($_args)
;
}}
...
// block presenter
//
if (!function_exists($_l->blocks['presenter'][] = '_lbc2dfb3f3a8_presenter')) { function _lbc2dfb3f3a8_presenter($_l, $_args) { extract($_args)
;
}}
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb94c6d45f7a_content')) { function _lb94c6d45f7a_content($_l, $_args) { extract($_args)
;
}}
...
// block _notes
//
if (!function_exists($_l->blocks['_notes'][] = '_lbda4fdb5f9e__notes')) { function _lbda4fdb5f9e__notes($_l, $_args) { extract($_args); $_control->validateControl('notes')
;$recently = Note::get(Note::VISITED);
                        ...
                        <div class="row last-visited">
                            ...
                            <ul>
<?php $iterations = 0; foreach ($recently as $p): Nette\Latte\Macros\CoreMacros::includeTemplate("../templates/Includes/product-list-mini.phtml", array('product'=>$p) + $template->getParameters(), $_l->templates['nl5xqx5wjr'])->render() ;$iterations++; endforeach ?>
                            </ul>
                            <hr class="clear" />
...
// block footer
//
if (!function_exists($_l->blocks['footer'][] = '_lb7ace920a5d_footer')) { function _lb7ace920a5d_footer($_l, $_args) { extract($_args)
;
}}
...
//
if (!function_exists($_l->blocks['_userinteractionwish'][] = '_lbf693b9fff7__userinteractionwish')) { function _lbf693b9fff7__userinteractionwish($_l, $_args) { extract($_args); $_control->validateControl('userinteractionwish')
;if (!isset($user->id)): ?>
...
<?php $iterations++; endforeach; array_pop($_l->its); $iterator = end($_l->its) ?>
                    ...
                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 top-hudba">
                        <h3>TOP hudba</h3>
<?php Nette\Latte\Macros\CoreMacros::includeTemplate("top-paticka.latte", array('type'=>'hudba') + $template->getParameters(), $_l->templates['nl5xqx5wjr'])->render() ?>
                    </div>

                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 top-filmy">
                        <h3>TOP filmy</h3>
<?php Nette\Latte\Macros\CoreMacros::includeTemplate("top-paticka.latte", array('type'=>'film') + $template->getParameters(), $_l->templates['nl5xqx5wjr'])->render() ?>
                    </div>
